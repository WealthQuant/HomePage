    ...
    .text-content {
      ...
      .cta-button {
        ...
        &:hover {
          ...
          box-shadow: 0 0.08rem 0.24rem rgba(255, 80, 30, 0.4);
        }
      }
    }
  }
...
@media (max-width: 768px) {
  ...
  .img2 .img2_content .product-card .product-info h3 {
    font-size: 0.28rem;
  }

  .img3 .img3_content .feature-item h4 {
    font-size: 0.22rem;
  }
}
</style>
